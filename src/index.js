    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView>
        <View style={styles.page}>
          ...
          <SectionList>
            <Posters
              source={require('./assets/posterImages/heros/SpiderMan.png')}
              realName={'Peter Park'}
              pseudonym={'Homem Aranha'}
            />
            <Posters
              source={require('./assets/posterImages/heros/BlackPanter.png')}
              realName={"T'Chala"}
              pseudonym={'Pantera Negra'}
            />
            <Posters
              source={{
                uri: 'https://super.abril.com.br/wp-content/uploads/2018/07/maxresdefault-22.jpg',
              }}
              realName={'Tony Stark'}
            ...
            <Posters
              source={{
                uri: 'https://static.wikia.nocookie.net/universocinematograficomarvel/images/4/4c/Thor-Ultimato.jpg/revision/latest?cb=20190514112708&path-prefix=pt',
              }}
          ...
          <SectionList>
            ...
            />
            <Posters
              source={require('./assets/posterImages/antiHeroes/venom.png')}
